          ...
          {isProfileDropdownOpen && (
            <div className="absolute right-1 top-full mt-3 text-white rounded-md shadow-lg z-30 bg-[#0d0d0d]">
              ...
              <ul className="py-2 text-sm space-y-2">
                <li>
                  <Link to="/dashboard" className="block px-4 mx-2 py-2 rounded-lg hover:bg-[#a7821b] cursor-pointer ease-in-out transition">
                    Dashboard
                  </Link>
                </li>
                <li>
                  <Link to="/dashboard/notifications" className="block px-4 mx-2 py-2 rounded-lg hover:bg-[#a7821b] cursor-pointer ease-in-out transition">
                    Notifications
                  </Link>
                </li>
                <li>
                  <Link to="/dashboard/profile" className="block px-4 mx-2 py-2 rounded-lg hover:bg-[#a7821b] cursor-pointer ease-in-out transition">
                    Settings
                  </Link>
                </li>
                  <li>
                    <Link to="/" className="block px-4 mx-2 py-2 rounded-lg hover:bg-[#a7821b] cursor-pointer ease-in-out transition">
                      User Panel
                    </Link>
                  </li>
              </ul>
