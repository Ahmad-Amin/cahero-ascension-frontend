    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      <button
        ...
        <div className="flex flex-row w-full mt-5">
          ...
          {!isEditing ? (
            <button
              className="border border-[#dbaa24] text-[#dbaa24] hover:bg-[#dbaa24] hover:text-white ease-in-out transition duration-300 w-36 h-12 px-3 rounded-lg"
        ...
        <div className="flex flex-row w-full h-auto mb-4">
          ...
          <div className="w-full flex justify-center space-x-5 pt-10">
            <button
              className="border border-[#dbaa24] text-[#dbaa24] w-44 h-12 rounded-lg hover:bg-[#dbaa24] hover:text-white transition duration-200"
              onClick={handleClose}
            ...
            <button
              className="bg-[#dbaa24] text-white rounded-lg w-44 h-12 hover:bg-[#e53939] transition duration-200"
