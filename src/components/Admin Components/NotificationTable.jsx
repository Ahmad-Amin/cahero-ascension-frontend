            ...
            {currentNotifications.map((notification) => (
              <tr key={notification.id} className="bg-transparent border-b border-[#878788]">
                ...
                <td className="px-6 py-4">
                  <button
                    className="font-medium text-white bg-[#dbaa24] hover:bg-[#a7821b] mr-2 rounded-lg h-8 w-auto px-3 ease-in-out transition duration-200"
                  ...
                  <button
                    ...
                    className="font-medium text-[#dbaa24] hover:bg-[#dbaa24] border border-[#dbaa24] hover:text-white rounded-lg h-8 w-auto px-3 ease-in-out transition duration-200"
                  >
                    Resend
                  </button>
                </td>
