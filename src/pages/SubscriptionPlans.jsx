    ...
    >
      <Box
        sx={{
          ...
          height: "100%",
          background: "linear-gradient(to right, #2f2814 0%, rgba(34, 14, 55, 0) 100%)",
          zIndex: 1,
        }}
      />
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0">
                <div className="flex flex-col items-center justify-center text-white h-full gap-3 md:gap-5 px-4 md:px-6">
                  ...
                  <h4 className="text-3xl md:text-4xl font-extrabold text-[#dbaa24]">{plan.price}</h4>
                  <Divider
                    sx={{
                      width: "85%",
                      my: 1,
                  ...
                  <button
                    variant="outlined"
                    className="mt-2 w-full max-w-[140px] sm:max-w-[180px] h-12 md:h-16 rounded-full border-2 border-[#dbaa24] text-[#dbaa24] hover:bg-[#dbaa24] font-bold hover:text-black ease-in-out transition duration-300"
                  >
                    Get Started
                  </button>
                  <button className="text-white mt-2 mb-2 text-xs md:text-sm underline font-semibold hover:text-[#dbaa24] ease-in-out transition duration-300">
