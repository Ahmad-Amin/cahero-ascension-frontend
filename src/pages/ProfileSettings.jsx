              ...
              <div className="flex flex-col items-center ">
                ...
                {selectedFile ? (
                  <>
                    ...
                    <button
                      className="text-[#dbaa24] hover:text-[#a7821b] ease-in-out transition duration-300 font-medium text-base mt-4"
                  ...
                  <label className="text-[#dbaa24] hover:text-[#a7821b] ease-in-out transition duration-300 font-medium text-base mt-4">
                    Change image
                    <input
                      type="file"
                      accept="image/*"
              ...
              <div className="mt-10 ml-10 w-auto flex-1">
                <div className="flex justify-between items-center">
                  ...
                  <div className="whitespace-nowrap">
                    {isEditing.profile ? (
                      <button
                        className="text-[#dbaa24] hover:text-[#a7821b] transition duration-300 text-base font-medium"
              ...
              <div className="mt-7 mx-4 md:mx-8">
                ...
                <div className="text-white  text-base font-normal flex justify-between w-auto">
                  ...
                  <div className="whitespace-nowrap">
                    {isEditing.bio ? (
                      <button
                        className="text-[#dbaa24] hover:text-[#a7821b] transition duration-300 font-medium"
