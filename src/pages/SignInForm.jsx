          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mx-10 mt-5 flex justify-between items-center">
              <FormControlLabel
                ...
                label="Remember me"
              />
              <button className="text-[#dbaa24] hover:text-[#a7821b] ease-in-out transition duration-300 text-base font-semibold">
                Forgot Password
              </button>
            </div>
            <div className="mx-10 mt-5 mb-10">
              <button
                className="bg-[#dbaa24] text-white rounded-lg py-2 w-full"
                type="submit"
              >
                Login
              </button>
            ...
            <div className="flex justify-center my-5">
              <p className="text-[#313131] text-sm font-semibold">
                ...
                <button className="text-[#dbaa24] hover:text-[#a7821b] ease-in-out transition duration-300" onClick={toggleSignUp}>
                  Sign up
                </button>
              </p>
            </div>
