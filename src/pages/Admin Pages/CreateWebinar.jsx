            ...
            <div className="py-8 w-1/2 flex-1">
              ...
              <div className="mt-5 flex items-center">
                <label className="text-white font-normal text-lg mr-5 flex items-center">
                  ...
                  <input
                    ...
                    className="ml-2 appearance-none border border-[#dbaa24] checked:bg-[#dbaa24] rounded-full w-5 h-5 cursor-pointer"
                  />
                </label>
              ...
              <div className="flex flex-row gap-6 mt-8">
                <div className="">
                  <button
                    type="button"
                    className="w-56 h-12 bg-transparent border-2 border-[#dbaa24] hover:border-0 hover:bg-[#dbaa24] ease-in-out transition duration-300 rounded-xl text-white font-semibold text-lg"
                  >
                    Share Invite Link
                  </button>
                </div>
                <div className="">
                  <button
                    type="submit"
                    className="w-56 h-12 bg-[#dbaa24] hover:bg-[#a7821b] ease-in-out transition duration-300 rounded-xl text-white font-semibold text-lg"
                  >
                    Create Webinar
                  </button>
                </div>
