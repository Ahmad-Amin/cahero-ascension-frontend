      ...
      >
        <div className="p-5">
            ...
            <div className="flex-1 w-full md:w-4/6 py-8">
              ...
              <div className="mt-5 relative">
                ...
                <div className="h-16 rounded-xl border-2 border-white bg-transparent flex items-center justify-between px-3 text-white">
                  ...
                  />
                  <div
                    className="bg-[#dbaa24] p-2 rounded-lg cursor-pointer"
          ...
          <div className="flex flex-row justify-end gap-6 mt-5 w-3/5">
            <div className="">
              <button className="w-auto px-3 h-12 bg-[#dbaa24] hover:bg-[#a7821b] ease-in-out transition duration-300 rounded-xl text-white font-semibold text-lg">
