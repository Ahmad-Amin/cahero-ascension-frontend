      ...
      >
        <form onSubmit={handleUpdateUser}>
          ...
          <div className="w-full h-auto flex justify-end mt-2 pr-10">
            <button className="text-xl font-semibold text-[#dbaa24] hover:text-[#a7821b] ease-in-out transition duration-300">
              Forgot Password?
            </button>
          </div>
          <div className="w-full h-auto flex justify-center mt-10">
            <button
              type="submit"
              className="text-white text-xl font-semibold bg-[#dbaa24] hover:bg-[#a7821b] ease-in-out transition duration-300 w-auto h-12 px-10 flex items-center justify-center rounded-lg mt-10"
            >
              Update Information
            </button>
          </div>
