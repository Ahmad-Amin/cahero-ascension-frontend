          ...
          <div className="flex-1">
            ...
            <div className="w-auto h-auto flex justify-end">
              <Link to="/dashboard/webinars/create-webinar">
                <button className="w-52 h-12 bg-[#dbaa24] text-white rounded-lg text-lg font-semibold hover:bg-[#3b2f83] ease-in-out transition duration-300">
                  Create Webinar
                </button>
              </Link>
            </div>
            ...
            <div className="w-auto h-auto flex justify-end">
              <Link to="/dashboard/webinars">
                <button className="w-52 h-12 text-[#dbaa24]  rounded-lg text-lg font-semibold hover:text-[#3b2f83] ease-in-out transition duration-300">
                  View All
                </button>
              </Link>
              </div>
