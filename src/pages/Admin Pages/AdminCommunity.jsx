      ...
      >
        <LoadingWrapper loading={fetchingPost || loading}>
          ...
          >
            ...
            <button
              className="bg-[#dbaa24] hover:bg-[#a7821b] transition duration-300 w-auto px-5 h-9 text-white font-semibold mr-10 rounded-lg z-10 "
                    ...
                    <div className="flex flex-row">
                      ...
                      <div className="flex flex-row m-5 space-x-3">
                        <div
                          ...
                          className="w-10 h-10 rounded-full border border-[#dbaa24] flex items-center justify-center cursor-pointer"
                        >
                          <SendIcon className="text-[#dbaa24]" />
                        </div>
                      </div>
                    </div>
                    {/* Comments List */}
