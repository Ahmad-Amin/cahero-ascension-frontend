      ...
      try {
        ...
        if (selectedNotification) {
          setNotificationData({
            ...
            recipientType: selectedNotification.recipientType,
            specificRecipient: selectedNotification.specificRecipient || "",
            externalNotificationDelivery: selectedNotification.externalNotificationDelivery || "none",
          ...
          <div className="flex flex-row items-center">
            ...
            <div className="space-x-5">
              <button
                ...
                className="w-44 px-3 h-12 bg-[#dbaa24] hover:bg-[#a7821b] ease-in-out transition duration-300 rounded-xl text-white font-semibold text-lg"
              >
                Save
              </button>
